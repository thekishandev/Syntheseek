...
import { NumberTicker } from "@/components/ui/number-tracker";
...
export function GitHubStarButton() {
    ...
    useEffect(() => {
        async function fetchStars() {
            try {
                const res = await fetch("https://api.github.com/repos/thekishandev/Syntheseek");
                if (res.ok) {
        ...
        <>
            ...
            >
                ...
                <div className="ml-2 flex items-center gap-1 text-sm md:flex">
                    ...
                    <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 w-[200px] h-[15px] rounded-full z-0 animate-rainbow bg-[linear-gradient(90deg,#ff4d4d,#ff00ff,#00ffff,#00ff00,#ffff00)] blur-2xl brightness-300 opacity-90 pointer-events-none" />
                </div>
            </Link>
        </>
    );
